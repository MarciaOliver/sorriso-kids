...
function obtemDados(collection) {
  ...
  firebase.database().ref(collection).on('value', (snapshot) => {
    ...
    cabecalho.insertCell().textContent = 'Nome da Criança'
    cabecalho.insertCell().textContent = 'Nascimento da Criança'
    cabecalho.insertCell().textContent = 'Email do Responsável'
    cabecalho.insertCell().textContent = 'Sexo'
    cabecalho.insertCell().textContent = 'Queixa da Criança'
    cabecalho.insertCell().textContent = 'Tratamento Indicado'
    ...
    snapshot.forEach(item => {
      ...
      novaLinha.insertCell().textContent = item.val().queixa
      novaLinha.insertCell().textContent = item.val().tratamento
...
function salvar(event, collection) {
  ...
  else if (document.getElementById('queixa').value === '') { alert('⚠️É obrigatório informar a queixa!') }
  else if (document.getElementById('tratamento').value === '') { alert('⚠️É obrigatório informar o tratamento!') }
